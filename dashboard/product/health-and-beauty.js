...
function loadJSONData() {
  ...
  fetch('../../assets/images/health-and-beauty/health.json')
...
function print(item) {
  ...
  document
    ...
    .insertAdjacentHTML(
      ...
      <div class="row g-0">
      <div class="col-md-4">
      <img class="img-fluid rounded-start" src="../../assets/images/health-and-beauty/${item.fileName}" style="height:10rem;" alt="Title"/>
